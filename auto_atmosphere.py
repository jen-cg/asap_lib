...
def auto_atmosphere(paramstxt=False,
    ...
    for i in range(len(params[0])):
        ...
        with open(os.path.join(os.getcwd(), 'interpol.com'), 'r') as file:
            # read a list of lines into data
            data = file.readlines()
        ...
        with open(os.path.join( os.getcwd(), 'interpol.com'), 'w') as file:
            file.writelines(data)

        # -----------------------------------------------Run Interpol.com------------------------------------------
        print('\n------- Running interpol.com for star %s of %s: ' % (i + 1, len(params[0])))
        print('\n')
        subprocess.call(os.path.join(os.getcwd(), 'interpol.com'))
