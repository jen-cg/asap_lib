...
set model_path = /arc5/home/jglover/GRACES/Code/MARCS/grids/standard/plane/

#MARCS binary format (.true.) or MARCS ASCII web format (.false.)?
set marcs_binary = '.false.'

set model1 = p6000_g+4.0_m0.0_t01_st_z-2.50_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model2 = p6000_g+4.0_m0.0_t01_st_z-2.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model3 = p6000_g+4.5_m0.0_t02_st_z-2.50_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model4 = p6000_g+4.5_m0.0_t01_st_z-2.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model5 = p6250_g+4.0_m0.0_t02_st_z-2.50_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model6 = p6250_g+4.0_m0.0_t02_st_z-2.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model7 = p6250_g+4.5_m0.0_t01_st_z-2.50_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model8 = p6250_g+4.5_m0.0_t01_st_z-2.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod

#enter here the values requested for the interpolated model 
foreach Tref   ( 6224.0 )
foreach loggref ( 4.36 )
foreach zref ( -2.31 )

set modele_out = scratch
set modele_out2 = /arc5/home/jglover/GRACES/Code/moog/${Tref}g${loggref}z${zref}.alt
